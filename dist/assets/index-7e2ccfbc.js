(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))o(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function n(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(t){if(t.ep)return;t.ep=!0;const i=n(t);fetch(t.href,i)}})();const e={laravel:{image:"laravel.png",name:"Laravel"},react:{image:"react.png",name:"React.js"},vue:{image:"vue.png",name:"Vue.js"},tailwind:{image:"tailwind.png",name:"Tailwind CSS"},vuetify:{image:"vuetify.svg",name:"Vuetify"},jquery:{image:"jquery.png",name:"jQuery"},mui:{image:"mui.png",name:"Material UI"},filament:{image:"filament.png",name:"Filament PHP"},nova:{image:"nova.png",name:"Nova Laravel"},inertia:{image:"inertia.png",name:"Inertia JS"},pusher:{image:"pusher.png",name:"Pusher"},java:{image:"java.png",name:"Java"},azure:{image:"azure.png",name:"Azure"},codeigniter:{image:"codeigniter.png",name:"Codeigniter"},bootstrap:{image:"bootstrap.png",name:"Bootstrap"}},m=[{name:"Mustard School",url:"https://mustardschools.app",image:"mustard.png",tags:[e.laravel,e.vue,e.vuetify]},{name:"FARMap",url:"https://www.farmap.com.au/",image:"farmap.png",tags:[e.laravel,e.vue,e.vuetify]},{name:"Asia Pacific Journal on Curriculum Studies",url:"https://apjcs.org/",image:"apjcs.png",tags:[e.laravel,e.vue,e.inertia]},{name:"Integrity Initiative",url:"https://integrityinitiative.org/",image:"integrity.png",tags:[e.laravel,e.nova]},{name:"Giving Tuesday PH",url:"https://givingtuesday.ph/",image:"givingtuesday.png",tags:[e.laravel,e.filament]},{name:"Girl Scouts of the Philippines",url:"https://girlscouts.org.ph/",image:"gsp.png",tags:[e.laravel,e.nova]},{name:"Facemask",url:"https://github.com/alladinmelico/facemask",image:"facemask.gif",tags:[e.laravel,e.vuetify,e.pusher,e.inertia]},{name:"SSC System",url:"https://github.com/alladinmelico/facemask",image:"ssc.png",tags:[e.laravel,e.react,e.mui,e.pusher,e.java]},{name:"E-Cookbook",url:"https://github.com/alladinmelico/integration2",image:"ecookbook.png",tags:[e.laravel,e.jquery,e.azure]},{name:"Online Student Resource System",url:"https://github.com/alladinmelico/SVNHS_Student_Resource_Center",image:"sir.jpg",tags:[e.codeigniter,e.bootstrap,e.azure]},{name:"Movie Android App",url:"https://github.com/alladinmelico/MovieDemo",image:"javamovie.jpeg",tags:[e.laravel,e.java]}];document.getElementById("projects-container").innerHTML=m.map(a=>{const r=a.tags.map(n=>`
      <div class="tech-pill">
        <div>
    ...
    `);return`
      <div class="projects__card">
        <img src="./${a.image}" alt="${a.name}" srcset="" loading="lazy">
        <div class="projects__card__details">
          <a href="${a.url}" target="_blank" class="card-title">${a.name}</a>
    ...
    `});const g=[{name:"Laravel",image:"laravel.png",url:"https://laravel.com/"},{name:"React.js",image:"react.png",url:"https://reactjs.org/"},{name:"Vue.js",image:"vue.png",url:"https://vuejs.org/"},{name:"Tailwind CS",image:"tailwind.png",url:"https://tailwindcss.com/"},{image:"vuetify.svg",name:"Vuetify",url:"https://vuetifyjs.com/en/"},{image:"jquery.svg",name:"jQuery",url:"https://jquery.com/"},{image:"mui.png",name:"Material UI",url:"https://mui.com/"},{image:"filament.svg",name:"Filament PHP",url:"https://filamentphp.com/"},{image:"nova.svg",name:"Nova Laravel",url:"https://nova.laravel.com/"},{image:"inertia.png",name:"Inertia JS",url:"https://inertiajs.com/"},{image:"pusher.png",name:"Pusher",url:"https://pusher.com/"},{image:"codeigniter.png",name:"Codeigniter",url:"https://codeigniter.com/"},{image:"bootstrap.png",name:"Bootstrap",url:"https://getbootstrap.com/"}];document.getElementById("techstacks-container").innerHTML=g.map(a=>`
  <a href="${a.url}" target="_blank" class="techstack">
    <div>
      <img src="/${a.image}" alt="${a.name}" class="logo" loading="lazy">
    </div>
    <p class="title">
      ${a.name}
    </p>
  </a>
`);const s=[{name:"melico.alladin@gmail.com",url:"mailto:melico.alladin@gmail.com",icon:`
    ...
    `},{name:"alladin-m",url:"https://linkedin.com/in/alladin-m/",icon:`
    ...
    `},{name:"alladinmelico",url:"https://github.com/alladinmelico",icon:`
    ...
    `},{name:"melico.alladin",url:"https://www.facebook.com/melico.alladin",icon:`
    ...
    `},{name:"Alladin",url:"viber://chat?number=9560333490",icon:`
    ...
    `}];document.getElementById("socmeds-container").innerHTML=s.map(a=>`
  <a href="${a.url}" target="_blank" rel="noopener noreferrer">
    ${a.icon}
    <p>${a.name}</p>    
    <img src="/arrow.svg" alt="arrow">         
  </a>
`);document.getElementById("socmed-icons-container").innerHTML=s.map(a=>`
  <a href="${a.url}" target="_blank" rel="noopener noreferrer">
    ${a.icon}
  </a>
`);
