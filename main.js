...
document.getElementById('techstacks-container').innerHTML = techs.map(tech => `
...
document.getElementById('socmeds-container').innerHTML = socmends.map(socmed => `
...
`)
document.getElementById('socmed-icons-container').innerHTML = socmends.map(socmed => `
  <a href="${socmed.url}" target="_blank" rel="noopener noreferrer">
    ${socmed.icon}
  </a>
`)